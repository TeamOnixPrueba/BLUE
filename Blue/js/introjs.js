  ...
  */
  ...
  function setShowElement(_ref) {
    ...
    if (currentElementPosition !== "absolute" && currentElementPosition !== "relative" && currentElementPosition !== "sticky" && currentElementPosition !== "fixed") {
      ...
      addClass(element, "position-relative");
    }
  }
  ...
  function setHelperLayerPosition(helperLayer) {
    if (helperLayer) {
      ...
      if (isFixed(currentElement.element)) {
        addClass(helperLayer, "position-fixed");
      } else {
        removeClass(helperLayer, "position-fixed");
      }
  ...
  function placeTooltip(targetElement, tooltipLayer, arrowLayer, hintMode) {
    ...
    tooltipLayer.className = ["introjs-tooltip padding-m", tooltipCssClass].filter(Boolean).join(" ");
  ...
  function _createBullets(targetElement) {
    ...
    var bulletsLayer = _createElement("div", {
      className: "introjs-bullets col-4 padding-reset"
    });

    if (this._options.showBullets === false) {
      bulletsLayer.style.visibility = "hidden";
    }

    var ulContainer = _createElement("ul", {
    className: "introjs-bullets-container" });
    ...
    forEach(this._introItems, function (_ref, i) {
      ...
      innerLi.className = "introjs-steps-li";
  ...
  function _updateBullets(oldReferenceLayer, targetElement) {
    if (this._options.showBullets) {
      oldReferenceLayer.querySelector(".introjs-bullets li > a.active").className = "visited";
      oldReferenceLayer.querySelector(".introjs-bullets li > a[data-stepnumber=\"".concat(targetElement.step, "\"]")).className = "active";
	  _removeVisitedStep.call(self, targetElement.step ,oldReferenceLayer);
    }
  }
  
  function _removeVisitedStep(stepActual, referenceLayer){
	if(referenceLayer.querySelector(".introjs-bullets li > a[data-stepnumber=\"".concat(stepActual + 1, "\"]"))){
		referenceLayer.querySelector(".introjs-bullets li > a[data-stepnumber=\"".concat(stepActual + 1, "\"]")).classList.remove("visited");
		_removeVisitedStep.call(self, stepActual+1 ,referenceLayer);
	}
}
  /**
  ...
  function _showElement(targetElement) {
    ...
    if (oldHelperLayer !== null && oldReferenceLayer !== null) {
      ...
      self._lastShowElementTimer = window.setTimeout(function () {
        ...
        if (oldHelperNumberLayer !== null) {
          oldHelperNumberLayer.innerHTML = "".concat(targetElement.step, " de ").concat(_this._introItems.length);
      ...
      var tooltipTextLayer = _createElement("div", {
        className: "introjs-tooltiptext bel-typography bel-typography-p"
      });
      var tooltipHeaderLayer = _createElement("div", {
        className: "display-flex align-items-center margin-bottom-m"
      });
      var tooltipTitleLayer = _createElement("h4", {
        className: "introjs-tooltip-title bel-typography bel-typography-h4 font-weight-bold line-height-m"
      });
      var buttonsLayer = _createElement("div");
      setStyle(helperLayer, {
        "box-shadow": "0 0 0 0 rgba(33, 33, 33, 0.8), rgba(33, 33, 33, ".concat(self._options.overlayOpacity.toString(), ") 0 0 0 5000px")
      ...
      buttonsLayer.className = "introjs-tooltipbuttons padding-top-m";
      ...
      if (this._options.showStepNumbers === true) {
        ...
        helperNumberLayer.innerHTML = "".concat(targetElement.step, " de ").concat(this._introItems.length);
      ...
      nextTooltipButton = _createElement("button");
      ...
      nextTooltipButton.onclick = function () {
        if (self._introItems.length - 1 !== self._currentStep) {
          ...
          try {
            registerGAEventTour('TOUR_GUIADO', self._options.tourName, 'Completado');
          } catch (error) {}
      ...
      prevTooltipButton = _createElement("button");
      ...
      skipTooltipButton = _createElement("a", {
        className: "introjs-skipbutton icon-main icon-error icon-main__xxs"
      });
      ...
      skipTooltipButton.onclick = function () {    
        try {
          registerGAEventTour('TOUR_GUIADO', self._options.tourName, 'Salir'+ (self._currentStep + 1));
        } catch (error) {}
      ...
      buttonsLayer.appendChild(_createBullets.call(this, targetElement));// Steps
      tooltipHeaderLayer.appendChild(skipTooltipButton); //in order to prevent displaying previous button always

      var containerTooltipButton = _createElement("div", {
        className: "col-8 display-flex justify-content-end padding-reset"
      });

      if (this._introItems.length > 1) {
        containerTooltipButton.appendChild(prevTooltipButton);
      } // we always need the next button because this
      // button changes to "Done" in the last step of the tour

   
     
      containerTooltipButton.appendChild(nextTooltipButton);
      buttonsLayer.appendChild(containerTooltipButton); //set proper position
      containerTooltipButton.appendChild(nextTooltipButton);
    ...
    if (this._currentStep === 0 && this._introItems.length > 1) {
      if (typeof nextTooltipButton !== "undefined" && nextTooltipButton !== null) {
        nextTooltipButton.className = "".concat(this._options.buttonClass, " introjs-nextbutton bel-btn-default bel-btn-default-active margin-left-s");
        nextTooltipButton.innerHTML = this._options.nextLabel;
      }

      if (this._options.hidePrev === true) {
        if (typeof prevTooltipButton !== "undefined" && prevTooltipButton !== null) {
          prevTooltipButton.className = "".concat(this._options.buttonClass, " introjs-prevbutton visibility-hidden bel-btn-secondary bel-btn-secondary-active");
        }
        ...
        if (typeof prevTooltipButton !== "undefined" && prevTooltipButton !== null) {
          prevTooltipButton.className = "".concat(this._options.buttonClass, " introjs-prevbutton bel-btn-secondary-disabled bel-btn-secondary");
        }
      }
    }
      ...
      // last step of tour
      if (typeof prevTooltipButton !== "undefined" && prevTooltipButton !== null) {
        prevTooltipButton.className = "".concat(this._options.buttonClass, " introjs-prevbutton bel-btn-secondary bel-btn-secondary-active");
      }

      if (this._options.hideNext === true) {
        if (typeof nextTooltipButton !== "undefined" && nextTooltipButton !== null) {
          nextTooltipButton.className = "".concat(this._options.buttonClass, " introjs-nextbutton visibility-hidden");
        }
        ...
        if (typeof nextTooltipButton !== "undefined" && nextTooltipButton !== null) {
          if (this._options.nextToDone === true) {
            ...
            addClass(nextTooltipButton, "".concat(this._options.buttonClass, " introjs-nextbutton introjs-donebutton bel-btn-default bel-btn-default-active"));
          } else {
  ...
  function onKeyDown(e) {
    ...
    if ((code === "Escape" || code === 27) && this._options.exitOnEsc === true) {
      try {
        registerGAEventTour('TOUR_GUIADO', this._options.tourName, 'Salir'+ (this._currentStep + 1));
      } catch (error) {}
  ...
  function showHint(stepId) {
    ...
    if (hint) {
      removeClass(hint, /display-none/g);
    }
  }
  /**
  ...
  function showHintDialog(stepId) {
    ...
    tooltipTextLayer.className = "introjs-tooltiptext bel-typography bel-typography-p";
  ...
  function addOverlayLayer(targetElm) {
    ...
    if (this._options.exitOnOverlayClick === true) {
      ...
      overlayLayer.onclick = function () {
        try {
          registerGAEventTour('TOUR_GUIADO', _this._options.tourName, 'Salir'+ (_this._currentStep + 1));
        } catch (error) {}
  ...
  function createGAEventTour(GAtrackId, trackPage){
    if(undefined == window.ga && "" != GAtrackId && "" != trackPage){
      ...
      ga('create', GAtrackId, trackPage);
      ga('require', 'ec');
    } 
  }
  
  function registerGAEventTour(eventCategory, eventAction, eventLabel) {
    ga('send', 'event', {
  ...
  function IntroJs(obj) {
    ...
    this._options = {
      ...
      /** nombre del tour que es usado para Google Analytics */
      tourName: "",

      /** Id de seguimiento para Google Analytics */
      GAtrackId: "UA-41847620-2",
      
       /** Pagina que se registrara en Google Analytics */
      trackPage: ""
  ...
  introJs.fn = IntroJs.prototype = {
    ...
    start: function start() {
      this.oncomplete(this._options.doneEventClick);
      introForElement.call(this, this._targetElement);
      try {
        createGAEventTour(this._options.GAtrackId, this._options.trackPage);
        registerGAEventTour('TOUR_GUIADO', this._options.tourName, 'Iniciado');
      } catch (error) {}
